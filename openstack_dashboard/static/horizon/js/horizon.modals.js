/*
 * Override to load the form inline instead of modal
 */
...
horizon.modals.modal_spinner = function (text) {
  ...
  horizon.modals.spinner.appendTo("#inline_modal_wrapper");
...
horizon.addInitFunction(function() {
  ...
  $(document).on('click', '.ajax-modal', function (evt) {
    ...
    horizon.modals._request = $.ajax($this.attr('data-create-url'), {
      beforeSend: function () {
