...
class MultiFormMixin(ContextMixin):
    """ Similiar behaviour of django's FormMixin but for multiple forms.
    """
    initals = {}
    forms_classes = []
    prefixes = {}
    ...
    def get_initial(self, form_class):
        ...
        return self.initial[form_class].copy()
    ...
    def _get_form(self, form_class):
        ...
        return form_class(**self.get_form_kwargs(form_class))
