...
urlpatterns = patterns('',
    url(r'^$',
        'django_openstack.views.admin.projects_list',
        name='admin_projects'),
    url(r'^add/$',
        'django_openstack.views.admin.add_project',
        name='add_project'),
    url(r'^(?P<project_name>[^/]+)/$',
        'django_openstack.views.admin.project_view',
        name='admin_project'),
    url(r'^(?P<project_name>[^/]+)/user/(?P<project_user>[^/]+)/delete/',
        'django_openstack.views.admin.delete_project_user',
        name='admin_project_delete_user'),
    url(r'^(?P<project_name>[^/]+)/delete/$',
        'django_openstack.views.admin.delete_project',
        name='delete_project'),
    url(r'^(?P<project_name>[^/]+)/user/add/$',
        'django_openstack.views.admin.add_project_user',
        name='add_project_user'),
    url(r'^(?P<project_name>[^/]+)/user/(?P<project_user>[^/]+)/$',
        'django_openstack.views.admin.project_user',
        name='project_user'),
    url(r'^(?P<project_id>[^/]+)/sendcredentials/$',
        'django_openstack.views.admin.project_sendcredentials',
        name='admin_project_sendcredentials'),
    url(r'^(?P<project_id>[^/]+)/start_vpn/$',
        'django_openstack.views.admin.project_start_vpn',
