...
urlpatterns = patterns('',
    ...
    url(r'^(?P<organization_id>[^/]+)/edit/$', 
            views.MultiFormView.as_view(), name='edit'), 
    url(r'^(?P<organization_id>[^/]+)/edit/info/$', 
            views.InfoFormView.as_view(), name='info'),
    url(r'^(?P<organization_id>[^/]+)/edit/contact/$', 
            views.ContactFormView.as_view(), name='contact'),
    url(r'^(?P<organization_id>[^/]+)/edit/avatar/$', 
            views.AvatarFormView.as_view(), name='avatar'),
    url(r'^(?P<organization_id>[^/]+)/edit/cancel/$', 
            views.CancelFormView.as_view(), name='cancel'),
)
